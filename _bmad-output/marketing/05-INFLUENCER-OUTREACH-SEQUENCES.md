# Thumbway Micro-Influencer Outreach Strategy
## LinkedIn & Twitter Influencer Engagement Playbook

**Goal:** Get respected voices in marketing/sales/freelancing to mention Thumbway
...
I built Thumbway - it's an approval tool that works inside ChatGPT. You write content in ChatGPT, say "send to client@email.com for approval," and they get a link to approve/reject.
...
We built Thumbway (approval tool for ChatGPT content) and we're trying to figure out our positioning.
...
You mentioned you liked what we're building with Thumbway. I have an idea.

Your audience deals with [specific pain] constantly. Thumbway solves that.
...
**Our role:** Add data/case study from Thumbway users on [approval outcomes]
...
### Newsletter Features:
- "Tool spotlight: Thumbway for ChatGPT users"
...
- "Building in public: Thumbway story"
